...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BLDSHARED': 'gcc -pthread -shared -L/lib/x86_64-linux-gnu -L/lib '
              '-L/usr/local/lib -L/usr/lib -L/lib/x86_64-linux-gnu -L/lib '
 ...
 'CONFIGURE_LDFLAGS': '-L/lib/x86_64-linux-gnu -L/lib -L/usr/local/lib '
                      '-L/usr/lib',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--prefix=' 'LDFLAGS=-L/lib/x86_64-linux-gnu -L/lib "
                "-L/usr/local/lib -L/usr/lib' 'CPPFLAGS=-I/usr/include'",
 'CONFINCLUDEDIR': '/include',
 'CONFINCLUDEPY': '/include/python3.6m',
 'COREPYTHONPATH': ':',
 'COVERAGE_INFO': '/tmp/builders/python3/code/cpython/coverage.info',
 'COVERAGE_REPORT': '/tmp/builders/python3/code/cpython/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include -I/usr/include -I/usr/include',
 'CXX': 'g++ -pthread',
 ...
 'LDFLAGS': '-L/lib/x86_64-linux-gnu -L/lib -L/usr/local/lib -L/usr/lib '
            '-L/lib/x86_64-linux-gnu -L/lib -L/usr/local/lib -L/usr/lib',
 'LDFLAGS_NODIST': '',
 'LDLAST': '',
 'LDLIBRARY': 'libpython3.6m.a',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -L/lib/x86_64-linux-gnu -L/lib '
             '-L/usr/local/lib -L/usr/lib -L/lib/x86_64-linux-gnu -L/lib '
             '-L/usr/local/lib -L/usr/lib',
 'LDVERSION': '3.6m',
 'LIBC': '',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   ...
                   '-I./Include -I/usr/include -I/usr/include  -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/lib/x86_64-linux-gnu -L/lib -L/usr/local/lib '
                    '-L/usr/lib -L/lib/x86_64-linux-gnu -L/lib '
                    '-L/usr/local/lib -L/usr/lib',
 'PY_CPPFLAGS': '-I. -I./Include -I/usr/include -I/usr/include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/lib/x86_64-linux-gnu -L/lib -L/usr/local/lib -L/usr/lib '
               '-L/lib/x86_64-linux-gnu -L/lib -L/usr/local/lib -L/usr/lib',
 'PY_LDFLAGS_NODIST': '',
 'Py_DEBUG': 0,
 'Py_ENABLE_SHARED': 0,
 ...
 'abs_builddir': '/tmp/builders/python3/code/cpython',
 'abs_srcdir': '/tmp/builders/python3/code/cpython',
 'datarootdir': '/share',
 'exec_prefix': '',
 'prefix': '',
 'srcdir': '.'}
